  ...
  return (
    <div className="tv-icon-container">
      <a
        ...
        href="https://www.tradingview.com/chart/29SNRMLp/?symbol=OANDA%3AXAUUSD"
        target="_blank"
        id="trading-view-icon"
      ...
      >
        ...
        <span className="tv-header__logo-text">
          <svg
            width="147"
            height="28"
            viewBox="0 0 147 28"
...
export default IconTradingView;
